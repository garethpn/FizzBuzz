...
public class FizzBuzzRuleTests
{
    ...
    [TestCase(10)]
    [TestCase(20)]
    public void Number_Divisible_By_3_only_or_5_only_Returns_False_For_FizzBuzz(int value)
    {
    ...
    [TestCase(30)]
    [TestCase(45)]
    public void Number_Divisible_By_Both_3_And_5_Returns_True_For_FizzBuzz(int value)
    {
        var fizzBuzzRule = new FizzBuzzRule();
